...
font_size_2 = col2.slider("Title font size:", min_value=6.0, max_value=12.6, value=8.4, step = 0.1)
...
style = col2.selectbox(
    'Card style:',
    (#'Standard', 
     'Corporate', 'Wellness 1', 'Wellness 2', 'Thrift Shop'),
    index=None,
...
def create_pdfs(file_dict, text_size, section_text_size, header_fontsize):
    ...
    font_3 = fitz.Font("font1", font_path_3) #fitz.Font("NoeDisplayBoldCheck", "NoeDisplay-Bold.ttf")
    font_4 = fitz.Font("font2", font_path_4) #f
            ...
            for i, r in data_df.iterrows():
                ...
                try:
                    ...
                    if style == 'Standard':
                        ...
                        insert_text_(r["Title"], 84, 59, font_path_1, 'font2', font_size_2, color = (1.0, 1.0, 1.0), )
                        ...
                        try:
                            address_1 = r["Address field 1"]
                            address_2 = r["Address field 2"]
                            if pd.isna(address_2):
                                address_2 = ''
                        except:
                            try:
                                address_1 = r["Address"]
                                ...
                                address_2 = ''
                        if address_2 == '':
                            insert_text_(address_1, 93.5, 124.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        else:
                            insert_text_(address_1, 93.5, 123, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                            insert_text_(address_2, 93.5, 131, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )  
                    elif style == 'Wellness 1':
                        doc = fitz.open("assets/wellness 1.pdf")
                        ...
                        insert_text_(name, 83, 49.5, font_path_1, 'font1', font_size_1, color = (1.0, 1.0, 1.0), ) #  (0.0627451, 0.18039216, 0.2627451)
                        insert_text_(r["Title"], 84, 59, font_path_1, 'font2', font_size_2, color = (1.0, 1.0, 1.0), )
                        insert_text_(r["Email"], 93.5, 89.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        insert_text_(r["Phone"], 93.5, 106.2, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        try:
                            address_1 = r["Address field 1"]
                            address_2 = r["Address field 2"]
                            if pd.isna(address_2):
                        ...
                        if address_2 == '':
                            ...
                            insert_text_(address_1, 93.5, 123, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                            insert_text_(address_2, 93.5, 131, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )  
                    elif style == 'Wellness 2':
                        doc = fitz.open("assets/wellness 2.pdf")
                        ...
                        insert_text_(name, 81, 61.5, font_path_1, 'font1', font_size_1, color = (1.0, 1.0, 1.0), ) #  (0.0627451, 0.18039216, 0.2627451)
                        insert_text_(r["Title"], 82, 71, font_path_1, 'font2', font_size_2, color = (1.0, 1.0, 1.0), )
                        insert_text_(r["Email"], 93.5, 89.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        insert_text_(r["Phone"], 93.5, 106.2, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        try:
                            address_1 = r["Address field 1"]
                        ...
                        if address_2 == '':
                            ...
                            insert_text_(address_1, 93.5, 123, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                            insert_text_(address_2, 93.5, 131, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )         
                    elif style == 'Thrift Shop':
                        doc = fitz.open("assets/thrift.pdf")
                        ...
                        insert_text_(name, 83, 34.5, font_path_1, 'font1', font_size_1, color = (1.0, 1.0, 1.0), ) #  (0.0627451, 0.18039216, 0.2627451)
                        insert_text_(r["Title"], 84, 43, font_path_1, 'font2', font_size_2 - 1, color = (1.0, 1.0, 1.0), )
                        insert_text_(r["Email"], 93.5, 65.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        try:
                            address_1 = r["Address field 1"]
                            address_2 = r["Address field 2"]
                            if pd.isna(address_2):
                            ...
                            try:
                                ...
                                address_2 = ''
                        if address_2 == '':
                            insert_text_(address_1, 93.5, 82, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        else:
                            insert_text_(address_1, 93.5, 78.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                            insert_text_(address_2, 93.5, 86.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )

                        insert_text_(r["Phone"], 93.5, 98.5, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        try:
                            insert_text_(r["Hours field 1"], 93.5, 115, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        except:
                            pass
                        try:
                            insert_text_(r["Hours field 2"], 93.5, 125, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )
                        except:
                            pass
                        try:
                            insert_text_(r["Hours field 3"], 93.5, 133, font_path_2, 'font2', font_size_3, color = (1.0, 1.0, 1.0), )  
                        except:
                            pass                                                                     
                    else:
